  ...
  for (const e of BUILT_IN_NODE_CATALOG) {
    await prisma.nodeCatalog.upsert({
      ...
      create: {
        ...
        ...(e.outputSchema != null ? { outputSchema: e.outputSchema as object } : {}),
        runtime: e.runtime,
        ...(e.azureTarget != null ? { azureTarget: e.azureTarget as object } : {}),
        ...(e.capabilities != null ? { capabilities: e.capabilities as object } : {}),
      },
      update: {
        displayName: e.displayName,
        category: e.category,
